...
\tightlist
\item
  Hva er (\textbf{SSM} / \textbf{(SST)}) * 100?
\end{enumerate}
...
\tightlist
\item
  Regn ut \textbf{Mean Squared Error (MSE)} og putt den inn i ANOVA-tabellen.
\end{enumerate}
...
\caption{**CAPTION THIS FIGURE!!**}\label{fig:unnamed-chunk-15}
\end{figure}
