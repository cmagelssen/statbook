...
\begin{quote}
(Sett dette inn i residual sum of squares (SSR).Dette kalles The model sum of squares (SSM) eller regression i statistiske programmer.
\end{quote}
...
\caption{Visualisering av error ved de ulike modellene}\label{fig:unnamed-chunk-3}
\end{figure}
...
\tightlist
\item
  Hvis du sammenligner med figuren til høyre (som kun er brukt et eksempel), vil du si at vår alternative modell er god?
\end{enumerate}
...
\caption{Slik designet Rønnestad et al.~(2007) sin studie}
\end{figure}
