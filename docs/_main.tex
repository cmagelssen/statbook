...
\hypersetup{
  pdftitle={Bygge statistiske modeller med kategoriske prediktorvariabler (ANOVA, t-test)},
  pdfauthor={Christian Magelssen og Knut Sindre Mølmen},
  hidelinks,
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{r }\OtherTok{\textless{}{-}} \FunctionTok{cor.test}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{vo2, dat}\SpecialCharTok{$}\NormalTok{lopsprestasjon, }\AttributeTok{method=}\StringTok{"pearson"}\NormalTok{)}
\NormalTok{r}
\end{Highlighting}
\end{Shaded}
