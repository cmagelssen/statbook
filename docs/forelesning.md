...
<img src="forelesning_files/figure-html/unnamed-chunk-1-1.png" alt="Modeller med forskjellig b1" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-1)Modeller med forskjellig b1</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="forelesning_files/figure-html/unnamed-chunk-2-1.png" alt="Modeller med forskjellig b0" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-2)Modeller med forskjellig b0</p>
</div>

<span style="font-size: 22px; font-weight: bold; color: var(--purple);">Hva blir vår modell?</span>

<div class="figure" style="text-align: center">
<img src="forelesning_files/figure-html/unnamed-chunk-3-1.png" alt="Vår data" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-3)Vår data</p>
</div>
