...
Riktig. Vi kan se at modellen vår har redusert error med 78 % i forhold til null-modellen. Dette verdien har mange forskjellige navn i statistikken, proportional reduction in error (PRE), R^2 og n^2. Men de referer alle til det samme og kommer med 'output' fra testen dere kjører. 
